...
public enum MultiplierSource {
    ...
    public static ItemStack getIcon(MultiplierSource multiplierSource) {
        switch (multiplierSource) {
            case PETS: return SkullCreator.itemFromBase64("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzk0MmU2YzM4YzNiYjQzY2FhMzhiYTViNDlhNDgwNDdmY2VlYzcwMGNlN2NiMWE3YzFkZTU2OTQxMGYzNWIzOSJ9fX0=");
