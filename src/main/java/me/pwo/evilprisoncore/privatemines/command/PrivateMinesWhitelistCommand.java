...
public class PrivateMinesWhitelistCommand extends PrivateMinesCommand {
    public PrivateMinesWhitelistCommand(PrivateMines privateMines) {
        super(privateMines);
    }
